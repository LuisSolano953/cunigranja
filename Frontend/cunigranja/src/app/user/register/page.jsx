...
function Registrarse() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      // Manejar específicamente el error de columna desconocida
      if (error.response?.data && error.response.data.includes("Unknown column 'ResetToken'")) {
        setError(
          ...
          <Card className="relative w-full shadow-xl">
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition duration-300 ease-in-out disabled:opacity-70 disabled:cursor-not-allowed"
                  disabled={isSubmitting}
                >
                  {isSubmitting ? (
              ...
              <div className="mt-4 space-y-4">
                <button
                  ...
                  className="w-full py-2 px-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-lg shadow-md transition duration-300 ease-in-out disabled:opacity-70 disabled:cursor-not-allowed"
                  disabled={isSubmitting}
                >
